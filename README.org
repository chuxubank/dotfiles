...
[[file:docs/keybindings/agents.md][docs/keybindings/agents.md]]; tool defaults
are in the per-tool files.

| Tool | Detailed bindings                      |
|------+----------------------------------------|
| Shared | [[file:docs/keybindings/agents.md][docs/keybindings/agents.md]] |
| Pi     | [[file:docs/keybindings/pi.md][docs/keybindings/pi.md]]           |
| OMP    | [[file:docs/keybindings/omp.md][docs/keybindings/omp.md]]         |
...
| =Ctrl+Shift+P= / =Ctrl+Shift+N= | Next/previous scoped model             |

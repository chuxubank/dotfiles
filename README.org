...
| =Enter=                  | Submit; Pi follow-up queue while working            |
| =Alt+Enter=              | Pi steer while working (swapped with Enter)         |

In Pi, =Alt+Up/Down=, =Alt+F=, and =Right= are shadowed while a
=pi-autosuggestions= ghost shows at the line end; see
[[file:docs/keybindings/agents/pi.md][pi.md]].
...
[[file:home/.chezmoidata/llm/omp.yaml][home/.chezmoidata/llm/omp.yaml]] whose
...
[[file:docs/llm/model-roles.md][docs/llm/model-roles.md]].

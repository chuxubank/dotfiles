...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-pinyin activities age agent-shell aider aidermacs
                ...
                math-delimiters md-babel meow-tree-sitter meow-vterm
                mermaid-mode minimap mistty mu4e-column-faces
                mu4e-overview nerd-icons-corfu nerd-icons-dired
                netease-cloud-music no-littering nov ns-auto-titlebar
                ob-aider ob-applescript ob-async ob-go ob-kotlin
                ob-powershell ob-swiftui oj org-agenda-count org-anki
                ...
                osx-plist ox-hugo ox-jira pangu-spacing pass
